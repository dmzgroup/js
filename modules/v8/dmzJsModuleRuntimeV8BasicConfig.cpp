...
V8Value
dmz::JsModuleRuntimeV8Basic::_config_attribute (const v8::Arguments &Args) {
   ...
   if (self) {
      ...
      if ((Length > 0) && ptr) {
         ...
         const String Path = v8_to_string (Args[0]);
         ...
         if (Path) {
            ...
            if (Length == 1) {
               ...
               if (ptr->lookup_attribute (Path, value)) {
               ...
               if (ptr->store_attribute (Path, Value)) {
