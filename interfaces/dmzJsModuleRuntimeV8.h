...
inline dmz::String
dmz::JsModuleRuntimeV8::get_js_module_runtime_v8_name () const { return __Info.get_name (); }


inline dmz::Handle
dmz::JsModuleRuntimeV8::get_js_module_runtime_v8_handle () const { return __Info.get_handle (); }
